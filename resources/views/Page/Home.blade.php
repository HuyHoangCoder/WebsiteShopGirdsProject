            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-product">
                    <div class="product-image">
                        <img src="{{asset('/')}}images/products/{{$sp->img}}" alt="#">
                        <div class="button">
                            <a href="javascript:void(0)" ng-click="addToCart({{$sp->id}}, 1)" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                        </div>
                    </div>
                    <div class="product-info">
                        <span class="category">{{$sp->category->name}}</span>
                        <h4 class="title">
                            <a href="{{route('detail', ['slug'=>$sp->slug])}}"> {{$sp->name}}</a>
                        </h4>
                        <ul class="review">
                        ...
                        <div class="price">
                            ...
                            <span>{{number_format($sp->sale_price)}}đ</span>
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        ...
                        <div class="single-product">
                            <div class="product-image">
                                ...
                                <div class="button">
                                    <a href="javascript: void(0) ng-click='addToCart()' " class="btn"><i class="lni lni-cart"></i> Add to
                                        Cart</a>
                                </div>
                            </div>
                            <div class="product-info">
